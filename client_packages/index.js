...
setInterval(function () {
    var name = (localplayer.getVariable('REMOTE_ID') == undefined) ? `Не авторизован` : `FiveUP GTA5RP`; 
	mp.discord.update('Играет на FiveUP RolePlay', name);
}, 10000);
...
mp.game.gxt.set("PM_PAUSE_HDR", "FiveUP Role Play");
